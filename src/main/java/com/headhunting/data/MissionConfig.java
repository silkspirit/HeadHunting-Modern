...
public class MissionConfig {
    ...
    public enum MissionType {
        ...
        FISH_CATCHES("Catch %d fish"),
        MINE_BLOCKS("Mine %d blocks"),
        MINE_SPECIFIC_BLOCK("Mine %d %s"),
        BREED_ANIMALS("Breed %d animals"),
        ENCHANT_ITEMS("Enchant %d items"),
        BREW_POTIONS("Brew %d potions"),
        TRADE_VILLAGERS("Trade with villagers %d times"),
        TAME_ANIMALS("Tame %d animals"),
        SMELT_ITEMS("Smelt %d items"),
        HARVEST_CROPS("Harvest %d crops"),
        PLACE_BLOCKS("Place %d blocks"),
        EAT_FOOD("Eat %d food items"),
